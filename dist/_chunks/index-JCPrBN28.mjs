...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-CkvfODo3.mjs")
    });
    app.registerPlugin({
      id: PLUGIN_ID,
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/ar.json": () => import("./ar-Bf9XlLLo.mjs"), "./translations/cs.json": () => import("./cs-B70riZPj.mjs"), "./translations/de.json": () => import("./de-B9kiAC-s.mjs"), "./translations/en.json": () => import("./en-Df-_Exku.mjs"), "./translations/es.json": () => import("./es-DlGQb34u.mjs"), "./translations/fr.json": () => import("./fr-hkSxFuzl.mjs"), "./translations/it.json": () => import("./it-C7z82V3g.mjs"), "./translations/ko.json": () => import("./ko-DVvHHUIT.mjs"), "./translations/ms.json": () => import("./ms-C1wNkEQw.mjs"), "./translations/nl.json": () => import("./nl-C79CwB4e.mjs"), "./translations/pl.json": () => import("./pl-_4ZTFbpK.mjs"), "./translations/pt-BR.json": () => import("./pt-BR-DjINUWGk.mjs"), "./translations/pt.json": () => import("./pt-BLr8DxNP.mjs"), "./translations/ru.json": () => import("./ru-C_7wBr9e.mjs"), "./translations/sk.json": () => import("./sk-i1gQKUBN.mjs"), "./translations/tr.json": () => import("./tr-BWNc97X3.mjs"), "./translations/uk.json": () => import("./uk-C_1qrLRM.mjs"), "./translations/vi.json": () => import("./vi-BfZkgFxI.mjs"), "./translations/zh-Hans.json": () => import("./zh-Hans-CXCr6QLu.mjs"), "./translations/zh.json": () => import("./zh-DucIAhMc.mjs") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
