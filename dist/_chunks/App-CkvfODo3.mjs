...
import { Flex, Loader, Card, CardHeader, CardAsset, CardTimer, CardBody, CardContent, CardSubtitle, CardBadge, Box, CardTitle, Typography, Grid, Pagination, PreviousLink, NextLink, PageLink, Dots, Field, Button, Combobox, ComboboxOption, IconButton, Checkbox, Link, ProgressBar, Modal, TextInput, Tabs, Accordion, Radio, Toggle, Badge, MultiSelect, MultiSelectOption, Dialog, Status, Textarea, SingleSelect, SingleSelectOption, Searchbar } from "@strapi/design-system";
import React from "react";
import { useIntl } from "react-intl";
import styled from "styled-components";
import { WarningCircle, Lock, Earth, Plus, Download, Trash, Pencil, Duplicate } from "@strapi/icons";
import { P as PLUGIN_ID, g as getTranslation, p as pluginPermissions } from "./index-JCPrBN28.mjs";
...
const AssetGrid = (props) => {
  ...
  if (muxAssets === void 0) return null;
...
const ListPagination = (props) => {
  ...
  if (page === void 0 || pages === void 0) return null;
...
const FileInput = (props) => {
  const { name, label = void 0, error = void 0, required = false, onFiles = () => {
  } } = props;
  const handleOnChange = (e) => onFiles(e.target.files);
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Field.Root, { name, error, children: [
            ...
            /* @__PURE__ */ jsxs(
              Radio.Group,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Radio.Item, { value: "premium", children: formatMessage({
...
const Summary = (props) => {
  ...
  if (muxAsset === void 0) return null;
...
const HomePage = () => {
  ...
  const loadMuxAssets = async () => {
    ...
    const sortVector = { field: "createdAt" };
